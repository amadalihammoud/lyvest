...
const slides = [
    { id: 1, image: "/banner-slide-1.webp", alt: "O abra├ºo do sol na sua pele - Cole├º├úo de Ver├úo Ly Vest" },
    { id: 2, image: "/banner-slide-2.webp", alt: "O conforto que te abra├ºa todo dia - Essenciais sem costura" }
];
