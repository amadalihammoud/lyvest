...
function HomePageContent() {
    ...
    useEffect(() => {
        // Skip first render to avoid overwriting URL params on page load
...
// Loading fallback for the page content
function HomePageSkeleton() {
    return (
        <div className="animate-pulse">
            {/* Hero skeleton */}
            <div className="bg-gradient-to-b from-rose-500 via-rose-600 to-white h-[60vh] min-h-[400px]"></div>
