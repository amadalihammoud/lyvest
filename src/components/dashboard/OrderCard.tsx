...
// Calculate progress based on status (pura — extraída para reduzir a complexidade de OrderCard).
...
// Get payment method display info (pura).
...
// Get status icon for history timeline (pura).
...
// Badge de status do pedido — extraído para baixar a complexidade de OrderCard (render idêntico).
function StatusBadge({ isDelivered, progress }: { isDelivered: boolean; progress: number }) {
    return (
...
// Barra de progresso do pedido (visível na visão expandida) — extraída para baixar a complexidade.
function ExpandedProgress({ progress }: { progress: number }) {
    return (
...
interface OrderDetailsProps {
    ...
    isDelivered: boolean;
    handleReview: (item?: OrderItem) => void;
}

// Seção de detalhes expandida (pagamento, endereço, resumo, itens, histórico, NF-e).
// Extraída de OrderCard para manter o componente principal com baixa complexidade (render idêntico).
function OrderDetails({ order, formatCurrency, isDelivered, handleReview }: OrderDetailsProps) {
    ...
    return (
        <div className="bg-white rounded-2xl shadow-sm border border-slate-100 overflow-hidden hover:shadow-md transition-shadow">
            ...
            <div className="p-6">
                <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4 mb-4">
                    <div>
                        ...
                        <div className="flex items-center gap-3">
                            ...
                            {/* Status Badge */}
                            <StatusBadge isDelivered={isDelivered} progress={progress} />
                        </div>
                    </div>
                ...
                {isExpanded && <ExpandedProgress progress={progress} />}
