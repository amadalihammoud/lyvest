    ...
    if (isLoading) {
        return (
            <div className="flex items-center justify-center py-20">
                <div className="w-10 h-10 border-4 border-lyvest-100 border-t-[#7D2121] rounded-full animate-spin" />
            </div>
        );
    }
                ...
                <form onSubmit={handleSave} className="space-y-5">
                    ...
                    <label className="flex items-center gap-3 cursor-pointer">
                        <input
                            ...
                            className="w-5 h-5 rounded text-lyvest-500 focus:ring-[#7D2121]"
                        />
