...
export default function MobileMenu({
    ...
    return (
        ...
        >
            ...
            <div className="absolute top-0 left-0 h-full w-4/5 max-w-sm bg-white shadow-2xl pt-16 pb-6 px-6 flex flex-col items-start overflow-y-auto overscroll-y-contain scroll-smooth safe-top safe-bottom">
