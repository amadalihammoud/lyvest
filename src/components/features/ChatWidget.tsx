                    ...
                    <div className="border-t border-slate-100 bg-white p-4">
                            ...
                            <div className="mb-3 flex gap-2 overflow-x-auto pb-1 scrollbar-hide">
                                {quickReplies.map((reply) => (
                                    <button
                                        ...
                                        className="whitespace-nowrap rounded-full border border-slate-200 bg-slate-50 px-3 py-1.5 text-xs font-medium text-slate-600 transition-colors hover:border-[#7D2121] hover:bg-white hover:text-[#7D2121]"
                                    >
                                        {reply}
                                    </button>
                                ))}
                        ...
                        <form onSubmit={handleSubmit} className="flex gap-2 relative">
                            <input
                                ...
                                className="flex-1 rounded-full border border-slate-200 bg-slate-50 pl-4 pr-10 py-2.5 text-sm transition-all focus:border-[#7D2121] focus:bg-white focus:outline-none focus:ring-1 focus:ring-[#7D2121]/20"
                            />
                            <button
                                type="submit"
                                disabled={isLoading || !(input || '').trim()}
                                className="absolute right-1 top-1 flex h-8 w-8 items-center justify-center rounded-full bg-[#7D2121] text-white transition-transform hover:bg-[#5A1A1A] active:scale-95 disabled:opacity-50 disabled:scale-100"
                            >
