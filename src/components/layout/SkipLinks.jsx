 ...
 * Permite usuÃ¡rios de teclado/leitores de tela pular para seÃ§Ãµes importantes
 * 
...
export default function SkipLinks() {
    ...
    const links = [
        {
            href: '#main-content',
            label: t('skipLinks.mainContent') || 'Pular para o conteÃºdo principal',
            color: 'bg-lyvest-500 focus:ring-offset-[#800020]'
        },
        {
            href: '#products-grid',
        ...
        {
            href: '#footer',
            label: t('skipLinks.footer') || 'Ir para o rodapÃ©',
    ...
    return (
        <nav
            aria-label={t('skipLinks.navigation') || 'Links de navegaÃ§Ã£o rÃ¡pida'}
